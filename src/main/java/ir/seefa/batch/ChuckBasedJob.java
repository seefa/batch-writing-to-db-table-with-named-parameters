...
public class ChuckBasedJob {
    ...
    public static String INSERT_CUSTOMER_SQL = "INSERT INTO " +
            ...
            + " VALUES(:customerNumber,:customerName,:contactLastName,:contactFirstName,:phone,:addressLine1,:addressLine2,:city,:state,:postalCode,:country,:creditLimit)";
    ...
    @Bean
    public Step chunkBasedWritingToDbTableWithNamedParametersStep() throws Exception {
        return this.stepBuilderFactory.get("chunkBasedWritingToDbTableWithNamedParametersStep")
    ...
    public Job chuckOrientedJob() throws Exception {
        return this.jobBuilderFactory.get("chunkOrientedWritingToDbTableWithNamedParametersJob")
                .start(chunkBasedWritingToDbTableWithNamedParametersStep())
                .build();
